...
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    ['title' => 'Stranger Things', 'synopsis' => 'Quand un jeune garçon disparaît, une petite ville découvre une affaire mystérieuse, des expériences secrètes, des forces surnaturelles terrifiantes... et une fillette.', 'category_name' => 'category_Action',  'country' => 'Américaine', 'year' => '2016', 'program_name' => 'Stranger Things'],
    ['title' => 'The Mandalorian', 'synopsis' => 'L\'intrigue, située entre la chute de l\'Empire et l\'émergence du Premier Ordre, 
    suit les voyages d\'un chasseur de primes solitaire dans les contrées les plus éloignées de la Galaxie, loin de l\’autorité de la Nouvelle République', 'category_name' => 'category_Aventure' ,  'country' => 'Américaine', 'year' => '2019', 'program_name' => 'The Mandalorian']
